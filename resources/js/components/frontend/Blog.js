        ...
        <section className="blog-area section-gap">
            ...
            <div className="row">
                ...
                <div className="single-blog">
                    <div className="thumb">
                    <img className="img-fluid" src="frontend/img/b1.jpg" alt="" />
                    </div>
                ...
                <div className="single-blog">
                    <div className="thumb">
                    <img className="img-fluid" src="frontend/img/b2.jpg" alt="" />
                    </div>
                    <div className="short_details">
                    <div className="meta-top d-flex">
                        <a href="#">By Admin</a>
                ...
                <div className="single-blog">
                    <div className="thumb">
                    <img className="img-fluid" src="frontend/img/b3.jpg" alt="" />
                    </div>
                    <div className="short_details">
                    <div className="meta-top d-flex">
                        <a href="#">By Admin</a>
