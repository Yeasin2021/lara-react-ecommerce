...
useEffect(()=>{
    const data = async () =>{
        const response = await axios.get('/banner').then((res)=>setItem(res.data.banner));
    }
    data();
},[])
  return (
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">First Header Section</th>
                                            <th scope="col">Second Header Section</th>
                                            <th scope="col">Third Header Section</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{item.title}</td>
                                            <td>{item.first_header}</td>
                                            <td>{item.second_header}</td>
                                            <td>{item.third_header}</td>
                                            <td>
