...
const onSubmitForm = async(e) =>{
    ...
    try{
        ...
        await axios.post(`/brand-update/${id}`,formData);
  ...
  return (
    ...
    <div className="col-lg-12">
        <div className="card">
            <div className="card-header"><strong>Brand Edit Page</strong> Groups</div>
                    ...
                    <div className="row form-group">
                        <div className="col col-md-12">
                            <div className="input-group">
                                ...
                                <input type="text" id="input1-group1" name="brand"  onChange={(e)=>setBrand(e.target.value)} placeholder="Enter Category" className="form-control" />
                            </div><br></br>
                            <div className="input-group">
                                <div className="input-group-addon"><i className="fa fa-file-text-o"></i></div>
                                <input type="text" id="input1-group1" name="brand_description"  onChange={(e)=>setDescription(e.target.value)} placeholder="Category Description" className="form-control" />
                            </div><br></br>
